...
tt_content.t3sbs_menu.20.9 {
	wrap = <div id="scrollspy" class="affixmenu"><ul class="nav" data-spy="affix" data-offset-top="{$plugin.t3sbootstrap_configuration.navigation.affix.data-offset-top}" data-offset-bottom="{$plugin.t3sbootstrap_configuration.navigation.affix.data-offset-bottom}">|</ul></div>
	table = tt_content
	select {
		pidInList = this
		orderBy = sorting
