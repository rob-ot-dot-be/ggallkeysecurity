...
RTE.default {
  ...
  # TEXTSTYLE
  buttons.textstyle.tags.span.allowedClasses := addToList(indent-1, indent-2, indent-3, badge, small, lead, text-muted, text-primary, text-success, text-info, text-warning, text-danger, alert, label, label-default, label-primary, label-success, label-info, label-warning, label-danger)




  # BLOCKSTYLE TABLE, DIV ...
  buttons.blockstyle.tags.ul.allowedClasses := addToList(list-unstyled, list-inline, label, label-default, label-primary, label-success, label-info, label-warning, label-danger)
