 ...
 */
if (\TYPO3\CMS\Core\Utility\GeneralUtility::compat_version('7.4')) {
	$GLOBALS['TCA']['tt_content']['types']['t3sbs_textpic']['columnsOverrides']['bodytext']['defaultExtras'] = 'richtext:rte_transform[flag=rte_enabled|mode=ts_css]';
	$GLOBALS['TCA']['tt_content']['types']['t3sbs_textpic']['showitem'] = '
		--palette--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:palette.general;general,
		--palette--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:palette.header;header,
		bodytext;Text,rte_enabled;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:rte_enabled_formlabel,
		--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.images, image,
		--palette--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:palette.imagelinks;imagelinks,
		tx_t3sbootstrap_imagestyle,
		--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.appearance,
	...
	if (\TYPO3\CMS\Core\Utility\GeneralUtility::compat_version('7.3')) {
		...
		$GLOBALS['TCA']['tt_content']['types']['t3sbs_textpic']['showitem'] = '
			--palette--;LLL:EXT:cms/locallang_ttc.xlf:palette.general;general,
			--palette--;LLL:EXT:cms/locallang_ttc.xlf:palette.header;header,
			bodytext;Text,rte_enabled;LLL:EXT:cms/locallang_ttc.xlf:rte_enabled_formlabel,
			--div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.images, image,
			--palette--;LLL:EXT:cms/locallang_ttc.xlf:palette.imagelinks;imagelinks,
			tx_t3sbootstrap_imagestyle,
			--div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.appearance,
...
if (\TYPO3\CMS\Core\Utility\GeneralUtility::compat_version('7.4')) {
	$GLOBALS['TCA']['tt_content']['types']['t3sbs_bullets']['showitem'] = '
		--palette--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:palette.general;general,
		--palette--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:palette.header;header,
		tx_t3sbootstrap_list_group,bodytext;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:bodytext.ALT.bulletlist_formlabel,
		--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.appearance,
		--palette--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:palette.frames;frames,
		--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access,
		--palette--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:palette.visibility;visibility,
	...
	if (\TYPO3\CMS\Core\Utility\GeneralUtility::compat_version('7.3')) {
		$GLOBALS['TCA']['tt_content']['types']['t3sbs_bullets']['showitem'] = '
			--palette--;LLL:EXT:cms/locallang_ttc.xlf:palette.general;general,
			--palette--;LLL:EXT:cms/locallang_ttc.xlf:palette.header;header,
			tx_t3sbootstrap_list_group, bodytext;LLL:EXT:cms/locallang_ttc.xlf:bodytext.ALT.bulletlist_formlabel,
			--div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.appearance,
			--palette--;LLL:EXT:cms/locallang_ttc.xlf:palette.frames;frames,
			--div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access,
			--palette--;LLL:EXT:cms/locallang_ttc.xlf:palette.visibility;visibility,
...
if (\TYPO3\CMS\Core\Utility\GeneralUtility::compat_version('7.4')) {
	$GLOBALS['TCA']['tt_content']['types']['t3sbs_table']['showitem'] = '
		CType,--palette--;;4,hidden,header,
		--palette--;;3,linkToTop,tx_t3sbootstrap_fontawesome_icon,--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:CType.I.5,layout,
		--palette--;;10,cols,bodytext,
		--palette--;;9,pi_flexform,--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:pages.tabs.access,starttime,endtime,fe_group
	';
} else {
	if (\TYPO3\CMS\Core\Utility\GeneralUtility::compat_version('7.3')) {
		$GLOBALS['TCA']['tt_content']['types']['t3sbs_table']['showitem'] = '
			CType,--palette--;;4,hidden,header,
			--palette--;;3,linkToTop,tx_t3sbootstrap_fontawesome_icon,--div--;LLL:EXT:cms/locallang_ttc.xlf:CType.I.5,layout,
			--palette--;;10,cols,bodytext,
			--palette--;;9,pi_flexform,--div--;LLL:EXT:cms/locallang_tca.xlf:pages.tabs.access,starttime,endtime,fe_group
		';
	} else {
		$GLOBALS['TCA']['tt_content']['types']['t3sbs_table']['showitem'] = '
 ...
 */
if (\TYPO3\CMS\Core\Utility\GeneralUtility::compat_version('7.4')) {
	$GLOBALS['TCA']['tt_content']['types']['t3sbs_panel']['columnsOverrides']['bodytext']['defaultExtras'] = 'richtext:rte_transform[flag=rte_enabled|mode=ts_css]';
	$GLOBALS['TCA']['tt_content']['types']['t3sbs_panel']['showitem'] = '
		--palette--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:palette.general;general,
		header, subheader, tx_t3sbootstrap_fontawesome_icon, tx_t3sbootstrap_panel_state,
		bodytext;Text,rte_enabled;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:rte_enabled_formlabel,
		--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.appearance,
		--palette--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:palette.frames;frames,
		--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access,
	...
	if (\TYPO3\CMS\Core\Utility\GeneralUtility::compat_version('7.3')) {
		...
		$GLOBALS['TCA']['tt_content']['types']['t3sbs_panel']['showitem'] = '
			...
			header, subheader, tx_t3sbootstrap_fontawesome_icon, tx_t3sbootstrap_panel_state,
			bodytext;Text,rte_enabled;LLL:EXT:cms/locallang_ttc.xml:rte_enabled_formlabel,
 ...
 */
if (\TYPO3\CMS\Core\Utility\GeneralUtility::compat_version('7.4')) {
	$GLOBALS['TCA']['tt_content']['types']['t3sbs_mediaobject']['columnsOverrides']['bodytext']['defaultExtras'] = 'richtext:rte_transform[flag=rte_enabled|mode=ts_css]';
	$GLOBALS['TCA']['tt_content']['types']['t3sbs_mediaobject']['showitem'] = '
		--palette--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:palette.general;general,image,
		--palette--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:palette.image_settings;image_settings,
		--palette--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:palette.imagelinks;imagelinks,tx_t3sbootstrap_media_position,tx_t3sbootstrap_media_alignment,header,header_link,
		subheader, tx_t3sbootstrap_fontawesome_icon,
		bodytext;Text,rte_enabled;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:rte_enabled_formlabel,
		--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.appearance,
		--palette--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:palette.frames;frames,
		--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access,
 ...
 */
if (\TYPO3\CMS\Core\Utility\GeneralUtility::compat_version('7.4')) {
	$GLOBALS['TCA']['tt_content']['types']['t3sbs_carousel']['columnsOverrides']['bodytext']['defaultExtras'] = 'richtext:rte_transform[flag=rte_enabled|mode=ts_css]';
	$GLOBALS['TCA']['tt_content']['types']['t3sbs_carousel']['showitem'] = '
		--palette--;LLL:EXT:cms/locallang_ttc.xml:palette.general;general,
		image,header, subheader, tx_t3sbootstrap_fontawesome_icon,
		bodytext;Text,rte_enabled;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:rte_enabled_formlabel,
		--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access,
		--palette--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:palette.visibility;visibility,
		--palette--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:palette.access;access,
 ...
 */
if (\TYPO3\CMS\Core\Utility\GeneralUtility::compat_version('7.4')) {
	$GLOBALS['TCA']['tt_content']['types']['t3sbs_thumbnails']['columnsOverrides']['bodytext']['defaultExtras'] = 'richtext:rte_transform[flag=rte_enabled|mode=ts_css]';
